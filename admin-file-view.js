...
const fileRecords = {
  "monitor-diary": {
    ...
    html: `
      <article class="role-diary-paper">
        ...
        <p>许知夏还在那里装的跟真事儿似的，要是把她一块儿献祭了就好了。她的那点小心思我还不知道，她那个哈希加密程序从创建账号的时候就已经留在我的后台里了。只要她有小动作，我就让方砚把她宰喽。<strong>已经死了1个人了，再死一个也无所谓了。</strong></p>
        <p>我给这个哈希加密器上了锁，这样我就能确保只有我能够偷偷访问信息委员的后台了。密码我老是忘记，还是应该写在这里才好。</p>
  ...
  "absence-correction": {
    ...
    html: `
      <dl class="role-file-change-list">
        <dt>修改日期</dt>
        <dd>2016-07-09 23:06</dd>
        <dt>修改账号</dt>
        <dd>admin-07</dd>
        <dt>修改内容</dt>
        <dd>已成功从学生名单中移除：林媛</dd>
      </dl>
    `
  },
  "soul-return-ritual": {
  ...
  "art-profile": {
    ...
    html: `
      ...
      <p>其作品常被评论为具有强烈的层次感与象征性，题材多与记忆、空间和人物关系有关。2019年7月9日发生工作室事故后，林若萱再无公开活动记录。</p>
  ...
  "hospital-report": {
    title: "病例",
    html: `
      <p>患者姓名：肖青。该病例于<strong>2016年8月9日</strong>建立，由旧系统扫描件转存为只读文本。</p>
      <p>初诊记录写着：事故发生一个月后，患者持续失眠、惊醒，开始回避毕业前夜的记忆。家属称其高考后情绪急剧波动。</p>
      <p>医生初步判断为<strong>怀疑因为高考出现心理问题</strong>；至<strong>2016年10月9日</strong>复诊时，相关记忆已经完全缺失，并出现身份妄想等精神问题。患者会对“班长”“六个人”“小青”等词产生明显回避。</p>
  ...
  "info-diary-02": {
    ...
    html: `
      <article class="role-diary-paper">
        ...
        <p>她不太想去，但又怕扫大家的兴。她还说运动委员也会去，而美术委员准备了纸和图案，班长的两个朋友负责看门。</p>
        <p>我问她是不是恶作剧，她说不知道，只听见他们提到一个从论坛上看到的都市传说。<strong>从那天以后，她就失踪了</strong>。</p>
        <p>但，最可怕的是，没有人记得媛媛了，他们都说我们班根本没有这个人。但是媛媛是我唯一的朋友啊，就连媛媛的家长也在说我玩笑说得太过了……</p>
        <p>我不相信，我一定会把媛媛带回来的，我会从班长开始逼问的。</p>
      </article>
    `
  },
  "soul-return-log": {
    ...
    html: `
      ...
      <p>原始记录显示现场共六人。返魂名单列出五名施术者：<strong>梁致远已经死亡</strong>；林若萱现实状态为<strong>植物人</strong>；魏兆、方砚均为<strong>失踪</strong>；肖青因愿望未实现而被标记为“神明未接纳”，现实状态为<strong>完全失忆并伴精神问题</strong>。</p>
